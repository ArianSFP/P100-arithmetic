...
initial=health();tag='w8-lowact-'+a.tag
note(f'HELD: {tag}; GPU{device} device lock only per user instruction, W8A8/W8A4 direct packed activation loads plus quantization against original Q8; bounded watchdog worker.')
