...
initial=health();tag='w16-reference-'+a.tag
note(f'HELD: {tag}; GPU{device} device lock only per user instruction, W16A16 predecoded weights and original Q8 paired reference; bounded watchdog worker.')
