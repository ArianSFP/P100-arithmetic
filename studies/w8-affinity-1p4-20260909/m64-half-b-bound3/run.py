...
ap=argparse.ArgumentParser();ap.add_argument('tag');ap.add_argument('--tokens',type=int,choices=[33,64,128,256,512],required=True);ap.add_argument('--projection',choices=['gu','down'],default='down');ap.add_argument('--memcheck',action='store_true');ap.add_argument('--ctas',type=int,choices=[1,2,3,4,5,6],default=3);a=ap.parse_args()
...
initial=health();tag='w8-affinity-m64-half-b-bound3-'+a.tag
