...
int main(int argc,char**argv)try{
 ...
 int candidate_grid=prop.multiProcessorCount*atoi(argv[7]);if(candidate_grid<prop.multiProcessorCount||candidate_grid>prop.multiProcessorCount*8)throw std::runtime_error("grid bound");
