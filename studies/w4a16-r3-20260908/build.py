...
assert all(re.fullmatch(r'HADD2\.F32 R\d+, R\d+\.(?:H0_H0|H1_H1)(?:\.reuse)?, -RZ\.H0_H0\s*',s) for s in conversions),'Unexpected HADD2 use beyond exact half widening'
...
files+=['../../archive/w4a16-20260908/build/kernels.cubin','../../archive/w4a16-r2-20260908/build/kernels.cubin']
assert hashlib.sha256((ROOT/files[-2]).read_bytes()).hexdigest()=='21e86e715086128e8929111fc57bb419dbe4e6c490a940c1234bfb8558020b2e','Sealed round-1 baseline changed'
assert hashlib.sha256((ROOT/files[-1]).read_bytes()).hexdigest()=='64fdbef07437dc6918821a6209577000cfe7f61a818fb973fd13b1c643d84d94','Sealed round-2 baseline changed'
