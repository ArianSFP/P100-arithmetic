...
files=['controls/w4a16-r3.cubin','kernels.cu','kernels.cubin','kernels.sass','worker.cpp','worker','cpu_checks.py','cpu-results.json','build.py']
...
print('PASS: CPU arithmetic, 59 compiled entry points, SASS and spill checks; no GPU execution')
